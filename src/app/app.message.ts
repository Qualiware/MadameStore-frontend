...
export class AppMessage implements InternacionalizacaoResource {
  ...
  constructor() {
    this.resource = {
      ...
      LABEL_PESQUISAR_TIPOPRODUTO: "Pesquisar Tipo Produto",
      LABEL_ALTERAR_TIPOPRODUTO: "Alterar Tipo Produto",
      LABEL_INCLUIR_TIPOPRODUTO: "Incluir Tipo Produto",
      LABEL_VISUALIZAR_TIPOPRODUTO: "Visualizar Tipo Produto",
