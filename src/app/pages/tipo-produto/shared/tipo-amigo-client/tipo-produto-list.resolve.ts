 ...
 */
@Injectable()
export class TipoProdutoListResolve implements Resolve<any> {
  ...
  constructor(
    ...
    private usuarioClientService: TipoProdutoClientService,
  ...
  resolve(route: ActivatedRouteSnapshot): Observable<any> {
    ...
    return new Observable(observer => {
      const filtro: FiltroTipoProdutoDTO = new FiltroTipoProdutoDTO();
      filtro.nome = '%%%%';
